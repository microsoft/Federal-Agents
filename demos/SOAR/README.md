...
See [SOAR Architecture](SOAR_ARCHITECTURE.md) for system context, component responsibilities, data flow, and the SOAR-to-SOAR_DocGen document-generation sequence.
